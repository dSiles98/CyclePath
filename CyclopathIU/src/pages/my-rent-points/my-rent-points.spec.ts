...
describe('Component: MyRentPointsPage', () => {
  let component: MyRentPointsPage;
  let fixture: ComponentFixture<MyRentPointsPage>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      imports: [
        IonicModule.forRoot(MyRentPointsPage),
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(MyRentPointsPage);
