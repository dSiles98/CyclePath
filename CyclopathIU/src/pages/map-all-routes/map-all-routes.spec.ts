...
describe('Component: MapAllRoutesPage', () => {
  let component: MapAllRoutesPage;
  let fixture: ComponentFixture<MapAllRoutesPage>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      imports: [
        IonicModule.forRoot(MapAllRoutesPage),
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(MapAllRoutesPage);
